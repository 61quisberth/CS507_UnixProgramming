/* shmget.c: This is a program to illustrates shared-memory-get, shmget(),
 * system call capabilities.
 *
 * This call creates a shared memory resource with the given key,
 * yielding a shmid
 *
 * asks for key
 * asks for operation permissions (access)
 * asks if it should create vs create-exclusive
 */
...
/* --------------------------------------------------------------------- */
/* main: C Language program begins here {{{2 */
int main()
{
int   flags;
int   opperm;
