/* msgop.c: this program illustrates Unix message operations:
 * msgsnd(), msgrcv() system call capabilities
 */
...
printf("Enter one of the following codes to send or receive a message\n");
printf("Send    = 1\n");
printf("Receive = 2\n");
