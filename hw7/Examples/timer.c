...
/* install SIGALRM signal handlers */
...
if     (sig == SIGALRM)   mesg= "SIGALRM";
else if(sig == SIGVTALRM) mesg= "SIGVTALRM";
else if(sig == SIGPROF)   mesg= "SIGPROF";
else                      mesg= "not an alarm signal";
return 0;
}
